...
public:
    ...
    {
        JSTimeRanges* ptr = new (NotNull, JSC::allocateCell<JSTimeRanges>(globalObject->globalData().heap)) JSTimeRanges(structure, globalObject, impl);
...
public:
    ...
    {
        JSTimeRangesPrototype* ptr = new (NotNull, JSC::allocateCell<JSTimeRangesPrototype>(globalData.heap)) JSTimeRangesPrototype(globalData, globalObject, structure);
...
public:
    ...
    static JSTimeRangesConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSTimeRangesConstructor* ptr = new (NotNull, JSC::allocateCell<JSTimeRangesConstructor>(*exec->heap())) JSTimeRangesConstructor(structure, globalObject);
