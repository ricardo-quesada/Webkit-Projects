...
public:
    ...
    {
        JSSVGStyleElement* ptr = new (NotNull, JSC::allocateCell<JSSVGStyleElement>(globalObject->globalData().heap)) JSSVGStyleElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGStyleElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGStyleElementPrototype>(globalData.heap)) JSSVGStyleElementPrototype(globalData, globalObject, structure);
...
public:
    ...
    {
        JSSVGStyleElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGStyleElementConstructor>(*exec->heap())) JSSVGStyleElementConstructor(structure, globalObject);
...
JSC::JSValue jsSVGStyleElementXmllang(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSSVGStyleElementXmllang(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsSVGStyleElementXmlspace(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
