...
public:
    ...
    {
        JSSVGFEMorphologyElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEMorphologyElement>(globalObject->globalData().heap)) JSSVGFEMorphologyElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGFEMorphologyElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGFEMorphologyElementPrototype>(globalData.heap)) JSSVGFEMorphologyElementPrototype(globalData, globalObject, structure);
...
JSC::JSValue jsSVGFEMorphologyElementClassName(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGFEMorphologyElementStyle(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
