...
public:
    ...
    {
        JSProgressEvent* ptr = new (NotNull, JSC::allocateCell<JSProgressEvent>(globalObject->globalData().heap)) JSProgressEvent(structure, globalObject, impl);
...
public:
    ...
    static JSProgressEventPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSProgressEventPrototype* ptr = new (NotNull, JSC::allocateCell<JSProgressEventPrototype>(globalData.heap)) JSProgressEventPrototype(globalData, globalObject, structure);
...
private:
    JSProgressEventPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
