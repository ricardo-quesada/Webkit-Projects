...
public:
    ...
    {
        JSSVGNumberList* ptr = new (NotNull, JSC::allocateCell<JSSVGNumberList>(globalObject->globalData().heap)) JSSVGNumberList(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGNumberListPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGNumberListPrototype>(globalData.heap)) JSSVGNumberListPrototype(globalData, globalObject, structure);
