...
public:
    ...
    {
        JSSVGMarkerElement* ptr = new (NotNull, JSC::allocateCell<JSSVGMarkerElement>(globalObject->globalData().heap)) JSSVGMarkerElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGMarkerElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGMarkerElementPrototype>(globalData.heap)) JSSVGMarkerElementPrototype(globalData, globalObject, structure);
...
JSC::JSValue jsSVGMarkerElementXmllang(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSSVGMarkerElementXmllang(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsSVGMarkerElementXmlspace(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
...
JSC::JSValue jsSVGMarkerElementClassName(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGMarkerElementStyle(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
