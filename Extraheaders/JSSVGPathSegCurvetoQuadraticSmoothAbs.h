...
public:
    ...
    {
        JSSVGPathSegCurvetoQuadraticSmoothAbs* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegCurvetoQuadraticSmoothAbs>(globalObject->globalData().heap)) JSSVGPathSegCurvetoQuadraticSmoothAbs(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGPathSegCurvetoQuadraticSmoothAbsPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegCurvetoQuadraticSmoothAbsPrototype>(globalData.heap)) JSSVGPathSegCurvetoQuadraticSmoothAbsPrototype(globalData, globalObject, structure);
...
public:
    ...
    static JSSVGPathSegCurvetoQuadraticSmoothAbsConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGPathSegCurvetoQuadraticSmoothAbsConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegCurvetoQuadraticSmoothAbsConstructor>(*exec->heap())) JSSVGPathSegCurvetoQuadraticSmoothAbsConstructor(structure, globalObject);
