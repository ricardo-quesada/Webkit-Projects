...
public:
    ...
    {
        JSScreen* ptr = new (NotNull, JSC::allocateCell<JSScreen>(globalObject->globalData().heap)) JSScreen(structure, globalObject, impl);
...
public:
    ...
    {
        JSScreenPrototype* ptr = new (NotNull, JSC::allocateCell<JSScreenPrototype>(globalData.heap)) JSScreenPrototype(globalData, globalObject, structure);
