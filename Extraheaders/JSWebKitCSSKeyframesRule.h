...
public:
    ...
    {
        JSWebKitCSSKeyframesRule* ptr = new (NotNull, JSC::allocateCell<JSWebKitCSSKeyframesRule>(globalObject->globalData().heap)) JSWebKitCSSKeyframesRule(structure, globalObject, impl);
...
public:
    ...
    {
        JSWebKitCSSKeyframesRulePrototype* ptr = new (NotNull, JSC::allocateCell<JSWebKitCSSKeyframesRulePrototype>(globalData.heap)) JSWebKitCSSKeyframesRulePrototype(globalData, globalObject, structure);
