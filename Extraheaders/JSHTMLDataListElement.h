...
public:
    ...
    {
        JSHTMLDataListElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLDataListElement>(globalObject->globalData().heap)) JSHTMLDataListElement(structure, globalObject, impl);
...
public:
    ...
    static JSHTMLDataListElementPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSHTMLDataListElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSHTMLDataListElementPrototype>(globalData.heap)) JSHTMLDataListElementPrototype(globalData, globalObject, structure);
...
private:
    JSHTMLDataListElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
