...
public:
    ...
    {
        JSHTMLBaseFontElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLBaseFontElement>(globalObject->globalData().heap)) JSHTMLBaseFontElement(structure, globalObject, impl);
...
public:
    ...
    static JSHTMLBaseFontElementPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSHTMLBaseFontElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSHTMLBaseFontElementPrototype>(globalData.heap)) JSHTMLBaseFontElementPrototype(globalData, globalObject, structure);
...
private:
    JSHTMLBaseFontElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
...
public:
    ...
    static JSHTMLBaseFontElementConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSHTMLBaseFontElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSHTMLBaseFontElementConstructor>(*exec->heap())) JSHTMLBaseFontElementConstructor(structure, globalObject);
