...
public:
    ...
    {
        JSOESTextureFloat* ptr = new (NotNull, JSC::allocateCell<JSOESTextureFloat>(globalObject->globalData().heap)) JSOESTextureFloat(structure, globalObject, impl);
...
public:
    ...
    {
        JSOESTextureFloatPrototype* ptr = new (NotNull, JSC::allocateCell<JSOESTextureFloatPrototype>(globalData.heap)) JSOESTextureFloatPrototype(globalData, globalObject, structure);
