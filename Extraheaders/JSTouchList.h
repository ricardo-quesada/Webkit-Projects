...
public:
    ...
    {
        JSTouchList* ptr = new (NotNull, JSC::allocateCell<JSTouchList>(globalObject->globalData().heap)) JSTouchList(structure, globalObject, impl);
...
public:
    ...
    {
        JSTouchListPrototype* ptr = new (NotNull, JSC::allocateCell<JSTouchListPrototype>(globalData.heap)) JSTouchListPrototype(globalData, globalObject, structure);
