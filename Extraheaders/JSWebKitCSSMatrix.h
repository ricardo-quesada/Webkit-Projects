...
public:
    ...
    {
        JSWebKitCSSMatrix* ptr = new (NotNull, JSC::allocateCell<JSWebKitCSSMatrix>(globalObject->globalData().heap)) JSWebKitCSSMatrix(structure, globalObject, impl);
...
public:
    ...
    static JSWebKitCSSMatrixPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSWebKitCSSMatrixPrototype* ptr = new (NotNull, JSC::allocateCell<JSWebKitCSSMatrixPrototype>(globalData.heap)) JSWebKitCSSMatrixPrototype(globalData, globalObject, structure);
...
private:
    JSWebKitCSSMatrixPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
    static const unsigned StructureFlags = JSC::OverridesGetOwnPropertySlot | Base::StructureFlags;
};
...
public:
    ...
    static JSWebKitCSSMatrixConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSWebKitCSSMatrixConstructor* ptr = new (NotNull, JSC::allocateCell<JSWebKitCSSMatrixConstructor>(*exec->heap())) JSWebKitCSSMatrixConstructor(structure, globalObject);
