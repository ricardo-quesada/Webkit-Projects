...
public:
    ...
    {
        JSClipboard* ptr = new (NotNull, JSC::allocateCell<JSClipboard>(globalObject->globalData().heap)) JSClipboard(structure, globalObject, impl);
...
public:
    ...
    {
        JSClipboardPrototype* ptr = new (NotNull, JSC::allocateCell<JSClipboardPrototype>(globalData.heap)) JSClipboardPrototype(globalData, globalObject, structure);
...
public:
    ...
    static JSClipboardConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSClipboardConstructor* ptr = new (NotNull, JSC::allocateCell<JSClipboardConstructor>(*exec->heap())) JSClipboardConstructor(structure, globalObject);
...
JSC::JSValue jsClipboardDropEffect(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSClipboardDropEffect(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsClipboardEffectAllowed(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSClipboardEffectAllowed(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsClipboardTypes(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsClipboardFiles(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
#if ENABLE(DATA_TRANSFER_ITEMS)
JSC::JSValue jsClipboardItems(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
#endif
JSC::JSValue jsClipboardConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
