...
#endif
#if ENABLE(SHADOW_DOM)
JSC::JSValue jsDOMWindowHTMLShadowElementConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSDOMWindowHTMLShadowElementConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
#endif
...
JSC::JSValue jsDOMWindowMediaKeyErrorConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSDOMWindowMediaKeyErrorConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
#endif
#if ENABLE(ENCRYPTED_MEDIA)
...
JSC::JSValue jsDOMWindowHTMLIntentElementConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSDOMWindowHTMLIntentElementConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
#endif
...
#endif
#if ENABLE(BLOB) && ENABLE(LEGACY_WEBKIT_BLOB_BUILDER)
JSC::JSValue jsDOMWindowWebKitBlobBuilderConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
...
#endif
#if ENABLE(INDEXED_DATABASE)
JSC::JSValue jsDOMWindowWebkitIDBDatabaseExceptionConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSDOMWindowWebkitIDBDatabaseExceptionConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
#endif
#if ENABLE(INDEXED_DATABASE)
