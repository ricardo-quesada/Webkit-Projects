...
public:
    ...
    {
        JSErrorEvent* ptr = new (NotNull, JSC::allocateCell<JSErrorEvent>(globalObject->globalData().heap)) JSErrorEvent(structure, globalObject, impl);
...
public:
    ...
    {
        JSErrorEventPrototype* ptr = new (NotNull, JSC::allocateCell<JSErrorEventPrototype>(globalData.heap)) JSErrorEventPrototype(globalData, globalObject, structure);
