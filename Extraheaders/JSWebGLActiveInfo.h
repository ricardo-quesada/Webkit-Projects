...
public:
    ...
    {
        JSWebGLActiveInfo* ptr = new (NotNull, JSC::allocateCell<JSWebGLActiveInfo>(globalObject->globalData().heap)) JSWebGLActiveInfo(structure, globalObject, impl);
...
public:
    ...
    {
        JSWebGLActiveInfoPrototype* ptr = new (NotNull, JSC::allocateCell<JSWebGLActiveInfoPrototype>(globalData.heap)) JSWebGLActiveInfoPrototype(globalData, globalObject, structure);
...
public:
    ...
    static JSWebGLActiveInfoConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSWebGLActiveInfoConstructor* ptr = new (NotNull, JSC::allocateCell<JSWebGLActiveInfoConstructor>(*exec->heap())) JSWebGLActiveInfoConstructor(structure, globalObject);
