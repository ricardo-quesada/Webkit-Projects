...
public:
    ...
    {
        JSCSSPrimitiveValue* ptr = new (NotNull, JSC::allocateCell<JSCSSPrimitiveValue>(globalObject->globalData().heap)) JSCSSPrimitiveValue(structure, globalObject, impl);
...
public:
    ...
    static JSCSSPrimitiveValuePrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSCSSPrimitiveValuePrototype* ptr = new (NotNull, JSC::allocateCell<JSCSSPrimitiveValuePrototype>(globalData.heap)) JSCSSPrimitiveValuePrototype(globalData, globalObject, structure);
...
private:
    JSCSSPrimitiveValuePrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
    static const unsigned StructureFlags = JSC::OverridesGetOwnPropertySlot | Base::StructureFlags;
};
...
public:
    ...
    static JSCSSPrimitiveValueConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSCSSPrimitiveValueConstructor* ptr = new (NotNull, JSC::allocateCell<JSCSSPrimitiveValueConstructor>(*exec->heap())) JSCSSPrimitiveValueConstructor(structure, globalObject);
