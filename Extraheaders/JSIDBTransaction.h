...
public:
    ...
    {
        JSIDBTransaction* ptr = new (NotNull, JSC::allocateCell<JSIDBTransaction>(globalObject->globalData().heap)) JSIDBTransaction(structure, globalObject, impl);
...
public:
    ...
    {
        JSIDBTransactionPrototype* ptr = new (NotNull, JSC::allocateCell<JSIDBTransactionPrototype>(globalData.heap)) JSIDBTransactionPrototype(globalData, globalObject, structure);
...
JSC::JSValue jsIDBTransactionREAD_ONLY(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsIDBTransactionREAD_WRITE(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsIDBTransactionVERSION_CHANGE(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
