...
public:
    ...
    static JSArrayBufferPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSArrayBufferPrototype* ptr = new (NotNull, JSC::allocateCell<JSArrayBufferPrototype>(globalData.heap)) JSArrayBufferPrototype(globalData, globalObject, structure);
...
private:
    JSArrayBufferPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
    static const unsigned StructureFlags = JSC::OverridesGetOwnPropertySlot | Base::StructureFlags;
};
...
JSC::EncodedJSValue JSC_HOST_CALL jsArrayBufferPrototypeFunctionSlice(JSC::ExecState*);
// Attributes

JSC::JSValue jsArrayBufferByteLength(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsArrayBufferConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
