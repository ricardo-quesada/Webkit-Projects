...
public:
    ...
    {
        JSHTMLModElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLModElement>(globalObject->globalData().heap)) JSHTMLModElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSHTMLModElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSHTMLModElementPrototype>(globalData.heap)) JSHTMLModElementPrototype(globalData, globalObject, structure);
