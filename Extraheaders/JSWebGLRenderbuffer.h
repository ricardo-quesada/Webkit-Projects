...
public:
    ...
    {
        JSWebGLRenderbuffer* ptr = new (NotNull, JSC::allocateCell<JSWebGLRenderbuffer>(globalObject->globalData().heap)) JSWebGLRenderbuffer(structure, globalObject, impl);
...
public:
    ...
    static JSWebGLRenderbufferPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSWebGLRenderbufferPrototype* ptr = new (NotNull, JSC::allocateCell<JSWebGLRenderbufferPrototype>(globalData.heap)) JSWebGLRenderbufferPrototype(globalData, globalObject, structure);
...
private:
    JSWebGLRenderbufferPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
