...
public:
    ...
    {
        JSWebKitTransitionEvent* ptr = new (NotNull, JSC::allocateCell<JSWebKitTransitionEvent>(globalObject->globalData().heap)) JSWebKitTransitionEvent(structure, globalObject, impl);
...
public:
    ...
    {
        JSWebKitTransitionEventPrototype* ptr = new (NotNull, JSC::allocateCell<JSWebKitTransitionEventPrototype>(globalData.heap)) JSWebKitTransitionEventPrototype(globalData, globalObject, structure);
