...
public:
    ...
    {
        JSCanvasRenderingContext2D* ptr = new (NotNull, JSC::allocateCell<JSCanvasRenderingContext2D>(globalObject->globalData().heap)) JSCanvasRenderingContext2D(structure, globalObject, impl);
...
public:
    ...
    static JSCanvasRenderingContext2DPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSCanvasRenderingContext2DPrototype* ptr = new (NotNull, JSC::allocateCell<JSCanvasRenderingContext2DPrototype>(globalData.heap)) JSCanvasRenderingContext2DPrototype(globalData, globalObject, structure);
...
private:
    JSCanvasRenderingContext2DPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
    static const unsigned StructureFlags = JSC::OverridesGetOwnPropertySlot | Base::StructureFlags;
};
