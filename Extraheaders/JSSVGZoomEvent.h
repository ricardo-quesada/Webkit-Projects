...
public:
    ...
    {
        JSSVGZoomEvent* ptr = new (NotNull, JSC::allocateCell<JSSVGZoomEvent>(globalObject->globalData().heap)) JSSVGZoomEvent(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGZoomEventPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGZoomEventPrototype>(globalData.heap)) JSSVGZoomEventPrototype(globalData, globalObject, structure);
...
public:
    ...
    static JSSVGZoomEventConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGZoomEventConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGZoomEventConstructor>(*exec->heap())) JSSVGZoomEventConstructor(structure, globalObject);
