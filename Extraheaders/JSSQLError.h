...
public:
    ...
    {
        JSSQLError* ptr = new (NotNull, JSC::allocateCell<JSSQLError>(globalObject->globalData().heap)) JSSQLError(structure, globalObject, impl);
...
public:
    ...
    {
        JSSQLErrorPrototype* ptr = new (NotNull, JSC::allocateCell<JSSQLErrorPrototype>(globalData.heap)) JSSQLErrorPrototype(globalData, globalObject, structure);
