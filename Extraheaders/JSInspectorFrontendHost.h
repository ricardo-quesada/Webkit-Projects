...
public:
    ...
    {
        JSInspectorFrontendHost* ptr = new (NotNull, JSC::allocateCell<JSInspectorFrontendHost>(globalObject->globalData().heap)) JSInspectorFrontendHost(structure, globalObject, impl);
...
public:
    ...
    {
        JSInspectorFrontendHostPrototype* ptr = new (NotNull, JSC::allocateCell<JSInspectorFrontendHostPrototype>(globalData.heap)) JSInspectorFrontendHostPrototype(globalData, globalObject, structure);
...
private:
    JSInspectorFrontendHostConstructor(JSC::Structure*, JSDOMGlobalObject*);
    void finishCreation(JSC::ExecState*, JSDOMGlobalObject*);

public:
    typedef DOMConstructorObject Base;
    static JSInspectorFrontendHostConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSInspectorFrontendHostConstructor* ptr = new (NotNull, JSC::allocateCell<JSInspectorFrontendHostConstructor>(*exec->heap())) JSInspectorFrontendHostConstructor(structure, globalObject);
...
JSC::JSValue jsInspectorFrontendHostConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
