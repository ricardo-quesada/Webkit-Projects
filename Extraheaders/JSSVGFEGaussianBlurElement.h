...
public:
    ...
    {
        JSSVGFEGaussianBlurElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEGaussianBlurElement>(globalObject->globalData().heap)) JSSVGFEGaussianBlurElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGFEGaussianBlurElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGFEGaussianBlurElementPrototype>(globalData.heap)) JSSVGFEGaussianBlurElementPrototype(globalData, globalObject, structure);
...
JSC::JSValue jsSVGFEGaussianBlurElementClassName(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGFEGaussianBlurElementStyle(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
