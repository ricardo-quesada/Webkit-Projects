...
public:
    ...
    {
        JSWebGLCompressedTextureS3TC* ptr = new (NotNull, JSC::allocateCell<JSWebGLCompressedTextureS3TC>(globalObject->globalData().heap)) JSWebGLCompressedTextureS3TC(structure, globalObject, impl);
...
public:
    ...
    static JSWebGLCompressedTextureS3TCPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSWebGLCompressedTextureS3TCPrototype* ptr = new (NotNull, JSC::allocateCell<JSWebGLCompressedTextureS3TCPrototype>(globalData.heap)) JSWebGLCompressedTextureS3TCPrototype(globalData, globalObject, structure);
...
private:
    JSWebGLCompressedTextureS3TCPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
