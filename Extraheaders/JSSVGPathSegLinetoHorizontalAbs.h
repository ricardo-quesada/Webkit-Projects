...
public:
    ...
    {
        JSSVGPathSegLinetoHorizontalAbs* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoHorizontalAbs>(globalObject->globalData().heap)) JSSVGPathSegLinetoHorizontalAbs(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGPathSegLinetoHorizontalAbsPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoHorizontalAbsPrototype>(globalData.heap)) JSSVGPathSegLinetoHorizontalAbsPrototype(globalData, globalObject, structure);
