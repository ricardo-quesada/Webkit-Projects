...
public:
    ...
    {
        JSCSSFontFaceRule* ptr = new (NotNull, JSC::allocateCell<JSCSSFontFaceRule>(globalObject->globalData().heap)) JSCSSFontFaceRule(structure, globalObject, impl);
...
public:
    ...
    static JSCSSFontFaceRulePrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSCSSFontFaceRulePrototype* ptr = new (NotNull, JSC::allocateCell<JSCSSFontFaceRulePrototype>(globalData.heap)) JSCSSFontFaceRulePrototype(globalData, globalObject, structure);
...
private:
    JSCSSFontFaceRulePrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
