...
public:
    ...
    {
        JSSVGAnimatedTransformList* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimatedTransformList>(globalObject->globalData().heap)) JSSVGAnimatedTransformList(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGAnimatedTransformListPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimatedTransformListPrototype>(globalData.heap)) JSSVGAnimatedTransformListPrototype(globalData, globalObject, structure);
