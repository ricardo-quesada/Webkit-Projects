...
public:
    ...
    {
        JSHTMLTextAreaElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLTextAreaElement>(globalObject->globalData().heap)) JSHTMLTextAreaElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSHTMLTextAreaElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSHTMLTextAreaElementPrototype>(globalData.heap)) JSHTMLTextAreaElementPrototype(globalData, globalObject, structure);
