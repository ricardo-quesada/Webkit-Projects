...
public:
    ...
    {
        JSMessageEvent* ptr = new (NotNull, JSC::allocateCell<JSMessageEvent>(globalObject->globalData().heap)) JSMessageEvent(structure, globalObject, impl);
...
public:
    ...
    {
        JSMessageEventPrototype* ptr = new (NotNull, JSC::allocateCell<JSMessageEventPrototype>(globalData.heap)) JSMessageEventPrototype(globalData, globalObject, structure);
