...
public:
    ...
    {
        JSSharedWorkerContext* ptr = new (NotNull, JSC::allocateCell<JSSharedWorkerContext>(globalData.heap)) JSSharedWorkerContext(globalData, structure, impl);
...
public:
    ...
    {
        JSSharedWorkerContextPrototype* ptr = new (NotNull, JSC::allocateCell<JSSharedWorkerContextPrototype>(globalData.heap)) JSSharedWorkerContextPrototype(globalData, globalObject, structure);
        ptr->finishCreation(globalData);
        return ptr;
    }
