...
public:
    ...
    {
        JSCanvasRenderingContext* ptr = new (NotNull, JSC::allocateCell<JSCanvasRenderingContext>(globalObject->globalData().heap)) JSCanvasRenderingContext(structure, globalObject, impl);
...
public:
    ...
    {
        JSCanvasRenderingContextPrototype* ptr = new (NotNull, JSC::allocateCell<JSCanvasRenderingContextPrototype>(globalData.heap)) JSCanvasRenderingContextPrototype(globalData, globalObject, structure);
...
private:
    JSCanvasRenderingContextConstructor(JSC::Structure*, JSDOMGlobalObject*);
    void finishCreation(JSC::ExecState*, JSDOMGlobalObject*);

public:
    typedef DOMConstructorObject Base;
    static JSCanvasRenderingContextConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSCanvasRenderingContextConstructor* ptr = new (NotNull, JSC::allocateCell<JSCanvasRenderingContextConstructor>(*exec->heap())) JSCanvasRenderingContextConstructor(structure, globalObject);
...
JSC::JSValue jsCanvasRenderingContextConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
