...
public:
    ...
    {
        JSSVGAnimatedRect* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimatedRect>(globalObject->globalData().heap)) JSSVGAnimatedRect(structure, globalObject, impl);
...
public:
    ...
    static JSSVGAnimatedRectPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSSVGAnimatedRectPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimatedRectPrototype>(globalData.heap)) JSSVGAnimatedRectPrototype(globalData, globalObject, structure);
...
private:
    JSSVGAnimatedRectPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
