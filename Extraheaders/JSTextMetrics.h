...
public:
    ...
    {
        JSTextMetrics* ptr = new (NotNull, JSC::allocateCell<JSTextMetrics>(globalObject->globalData().heap)) JSTextMetrics(structure, globalObject, impl);
...
public:
    ...
    {
        JSTextMetricsPrototype* ptr = new (NotNull, JSC::allocateCell<JSTextMetricsPrototype>(globalData.heap)) JSTextMetricsPrototype(globalData, globalObject, structure);
...
public:
    ...
    static JSTextMetricsConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSTextMetricsConstructor* ptr = new (NotNull, JSC::allocateCell<JSTextMetricsConstructor>(*exec->heap())) JSTextMetricsConstructor(structure, globalObject);
