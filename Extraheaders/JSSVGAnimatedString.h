...
public:
    ...
    {
        JSSVGAnimatedString* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimatedString>(globalObject->globalData().heap)) JSSVGAnimatedString(structure, globalObject, impl);
...
public:
    ...
    static JSSVGAnimatedStringPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSSVGAnimatedStringPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimatedStringPrototype>(globalData.heap)) JSSVGAnimatedStringPrototype(globalData, globalObject, structure);
...
private:
    JSSVGAnimatedStringPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
