...
public:
    ...
    {
        JSSVGAnimatedInteger* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimatedInteger>(globalObject->globalData().heap)) JSSVGAnimatedInteger(structure, globalObject, impl);
...
public:
    ...
    static JSSVGAnimatedIntegerPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSSVGAnimatedIntegerPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimatedIntegerPrototype>(globalData.heap)) JSSVGAnimatedIntegerPrototype(globalData, globalObject, structure);
...
private:
    JSSVGAnimatedIntegerPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
...
public:
    ...
    {
        JSSVGAnimatedIntegerConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimatedIntegerConstructor>(*exec->heap())) JSSVGAnimatedIntegerConstructor(structure, globalObject);
