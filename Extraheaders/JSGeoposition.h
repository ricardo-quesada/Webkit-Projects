...
public:
    ...
    {
        JSGeoposition* ptr = new (NotNull, JSC::allocateCell<JSGeoposition>(globalObject->globalData().heap)) JSGeoposition(structure, globalObject, impl);
...
public:
    ...
    {
        JSGeopositionPrototype* ptr = new (NotNull, JSC::allocateCell<JSGeopositionPrototype>(globalData.heap)) JSGeopositionPrototype(globalData, globalObject, structure);
