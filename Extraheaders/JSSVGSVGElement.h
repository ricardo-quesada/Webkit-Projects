...
public:
    ...
    {
        JSSVGSVGElement* ptr = new (NotNull, JSC::allocateCell<JSSVGSVGElement>(globalObject->globalData().heap)) JSSVGSVGElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGSVGElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGSVGElementPrototype>(globalData.heap)) JSSVGSVGElementPrototype(globalData, globalObject, structure);
...
JSC::JSValue jsSVGSVGElementRequiredFeatures(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGSVGElementRequiredExtensions(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGSVGElementSystemLanguage(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGSVGElementXmllang(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSSVGSVGElementXmllang(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsSVGSVGElementXmlspace(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
...
JSC::JSValue jsSVGSVGElementClassName(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGSVGElementStyle(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGSVGElementNearestViewportElement(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGSVGElementFarthestViewportElement(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
