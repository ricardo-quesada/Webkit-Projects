...
public:
    ...
    {
        JSSVGSetElement* ptr = new (NotNull, JSC::allocateCell<JSSVGSetElement>(globalObject->globalData().heap)) JSSVGSetElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGSetElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGSetElementPrototype>(globalData.heap)) JSSVGSetElementPrototype(globalData, globalObject, structure);
...
public:
    ...
    static JSSVGSetElementConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGSetElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGSetElementConstructor>(*exec->heap())) JSSVGSetElementConstructor(structure, globalObject);
