...
public:
    ...
    {
        JSHTMLDocument* ptr = new (NotNull, JSC::allocateCell<JSHTMLDocument>(globalObject->globalData().heap)) JSHTMLDocument(structure, globalObject, impl);
...
public:
    ...
    {
        JSHTMLDocumentPrototype* ptr = new (NotNull, JSC::allocateCell<JSHTMLDocumentPrototype>(globalData.heap)) JSHTMLDocumentPrototype(globalData, globalObject, structure);
