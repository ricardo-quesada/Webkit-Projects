...
public:
    ...
    {
        JSDOMSettableTokenList* ptr = new (NotNull, JSC::allocateCell<JSDOMSettableTokenList>(globalObject->globalData().heap)) JSDOMSettableTokenList(structure, globalObject, impl);
...
public:
    ...
    static JSDOMSettableTokenListPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSDOMSettableTokenListPrototype* ptr = new (NotNull, JSC::allocateCell<JSDOMSettableTokenListPrototype>(globalData.heap)) JSDOMSettableTokenListPrototype(globalData, globalObject, structure);
...
private:
    JSDOMSettableTokenListPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
