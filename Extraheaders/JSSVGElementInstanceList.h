...
public:
    ...
    {
        JSSVGElementInstanceList* ptr = new (NotNull, JSC::allocateCell<JSSVGElementInstanceList>(globalObject->globalData().heap)) JSSVGElementInstanceList(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGElementInstanceListPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGElementInstanceListPrototype>(globalData.heap)) JSSVGElementInstanceListPrototype(globalData, globalObject, structure);
