...
public:
    ...
    {
        JSEntity* ptr = new (NotNull, JSC::allocateCell<JSEntity>(globalObject->globalData().heap)) JSEntity(structure, globalObject, impl);
...
public:
    ...
    {
        JSEntityPrototype* ptr = new (NotNull, JSC::allocateCell<JSEntityPrototype>(globalData.heap)) JSEntityPrototype(globalData, globalObject, structure);
