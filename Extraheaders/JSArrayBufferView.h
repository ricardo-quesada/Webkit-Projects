...
JSC::JSValue jsArrayBufferViewBuffer(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsArrayBufferViewByteOffset(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsArrayBufferViewByteLength(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
