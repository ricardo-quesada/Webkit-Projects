...
public:
    ...
    {
        JSAbstractView* ptr = new (NotNull, JSC::allocateCell<JSAbstractView>(globalObject->globalData().heap)) JSAbstractView(structure, globalObject, impl);
...
public:
    ...
    static JSAbstractViewPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSAbstractViewPrototype* ptr = new (NotNull, JSC::allocateCell<JSAbstractViewPrototype>(globalData.heap)) JSAbstractViewPrototype(globalData, globalObject, structure);
...
private:
    JSAbstractViewPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
