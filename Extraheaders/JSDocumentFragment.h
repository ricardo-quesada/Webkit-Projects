...
public:
    ...
    {
        JSDocumentFragment* ptr = new (NotNull, JSC::allocateCell<JSDocumentFragment>(globalObject->globalData().heap)) JSDocumentFragment(structure, globalObject, impl);
...
public:
    ...
    {
        JSDocumentFragmentPrototype* ptr = new (NotNull, JSC::allocateCell<JSDocumentFragmentPrototype>(globalData.heap)) JSDocumentFragmentPrototype(globalData, globalObject, structure);
...
public:
    ...
    {
        JSDocumentFragmentConstructor* ptr = new (NotNull, JSC::allocateCell<JSDocumentFragmentConstructor>(*exec->heap())) JSDocumentFragmentConstructor(structure, globalObject);
