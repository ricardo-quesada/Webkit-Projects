...
public:
    ...
    {
        JSXSLTProcessor* ptr = new (NotNull, JSC::allocateCell<JSXSLTProcessor>(globalObject->globalData().heap)) JSXSLTProcessor(structure, globalObject, impl);
...
public:
    ...
    {
        JSXSLTProcessorPrototype* ptr = new (NotNull, JSC::allocateCell<JSXSLTProcessorPrototype>(globalData.heap)) JSXSLTProcessorPrototype(globalData, globalObject, structure);
