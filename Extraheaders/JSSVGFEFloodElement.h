...
public:
    ...
    {
        JSSVGFEFloodElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEFloodElement>(globalObject->globalData().heap)) JSSVGFEFloodElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGFEFloodElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGFEFloodElementPrototype>(globalData.heap)) JSSVGFEFloodElementPrototype(globalData, globalObject, structure);
...
JSC::JSValue jsSVGFEFloodElementClassName(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGFEFloodElementStyle(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
