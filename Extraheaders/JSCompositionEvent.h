...
public:
    ...
    {
        JSCompositionEvent* ptr = new (NotNull, JSC::allocateCell<JSCompositionEvent>(globalObject->globalData().heap)) JSCompositionEvent(structure, globalObject, impl);
...
public:
    ...
    static JSCompositionEventPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSCompositionEventPrototype* ptr = new (NotNull, JSC::allocateCell<JSCompositionEventPrototype>(globalData.heap)) JSCompositionEventPrototype(globalData, globalObject, structure);
...
private:
    JSCompositionEventPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
    static const unsigned StructureFlags = JSC::OverridesGetOwnPropertySlot | Base::StructureFlags;
};
