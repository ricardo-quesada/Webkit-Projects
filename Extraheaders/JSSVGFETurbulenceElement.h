...
public:
    ...
    {
        JSSVGFETurbulenceElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFETurbulenceElement>(globalObject->globalData().heap)) JSSVGFETurbulenceElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGFETurbulenceElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGFETurbulenceElementPrototype>(globalData.heap)) JSSVGFETurbulenceElementPrototype(globalData, globalObject, structure);
...
JSC::JSValue jsSVGFETurbulenceElementClassName(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGFETurbulenceElementStyle(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
