...
public:
    ...
    {
        JSSVGAnimatedLengthList* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimatedLengthList>(globalObject->globalData().heap)) JSSVGAnimatedLengthList(structure, globalObject, impl);
...
public:
    ...
    static JSSVGAnimatedLengthListPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSSVGAnimatedLengthListPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimatedLengthListPrototype>(globalData.heap)) JSSVGAnimatedLengthListPrototype(globalData, globalObject, structure);
...
private:
    JSSVGAnimatedLengthListPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
