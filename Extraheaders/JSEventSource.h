...
public:
    ...
    {
        JSEventSource* ptr = new (NotNull, JSC::allocateCell<JSEventSource>(globalObject->globalData().heap)) JSEventSource(structure, globalObject, impl);
...
public:
    ...
    {
        JSEventSourcePrototype* ptr = new (NotNull, JSC::allocateCell<JSEventSourcePrototype>(globalData.heap)) JSEventSourcePrototype(globalData, globalObject, structure);
...
public:
    ...
    {
        JSEventSourceConstructor* ptr = new (NotNull, JSC::allocateCell<JSEventSourceConstructor>(*exec->heap())) JSEventSourceConstructor(structure, globalObject);
