...
public:
    ...
    {
        JSPopStateEvent* ptr = new (NotNull, JSC::allocateCell<JSPopStateEvent>(globalObject->globalData().heap)) JSPopStateEvent(structure, globalObject, impl);
...
public:
    ...
    {
        JSPopStateEventPrototype* ptr = new (NotNull, JSC::allocateCell<JSPopStateEventPrototype>(globalData.heap)) JSPopStateEventPrototype(globalData, globalObject, structure);
