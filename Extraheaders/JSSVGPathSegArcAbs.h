...
public:
    ...
    {
        JSSVGPathSegArcAbs* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegArcAbs>(globalObject->globalData().heap)) JSSVGPathSegArcAbs(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGPathSegArcAbsPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegArcAbsPrototype>(globalData.heap)) JSSVGPathSegArcAbsPrototype(globalData, globalObject, structure);
...
public:
    ...
    static JSSVGPathSegArcAbsConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGPathSegArcAbsConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegArcAbsConstructor>(*exec->heap())) JSSVGPathSegArcAbsConstructor(structure, globalObject);
