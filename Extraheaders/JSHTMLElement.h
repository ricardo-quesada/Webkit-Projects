...
JSC::JSValue jsHTMLElementClassName(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSHTMLElementClassName(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsHTMLElementClassList(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
