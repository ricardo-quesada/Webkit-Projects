...
public:
    ...
    {
        JSDOMCoreException* ptr = new (NotNull, JSC::allocateCell<JSDOMCoreException>(globalObject->globalData().heap)) JSDOMCoreException(structure, globalObject, impl);
...
public:
    ...
    {
        JSDOMCoreExceptionPrototype* ptr = new (NotNull, JSC::allocateCell<JSDOMCoreExceptionPrototype>(globalData.heap)) JSDOMCoreExceptionPrototype(globalData, globalObject, structure);
