...
public:
    ...
    {
        JSSQLTransactionSync* ptr = new (NotNull, JSC::allocateCell<JSSQLTransactionSync>(globalObject->globalData().heap)) JSSQLTransactionSync(structure, globalObject, impl);
...
public:
    ...
    {
        JSSQLTransactionSyncPrototype* ptr = new (NotNull, JSC::allocateCell<JSSQLTransactionSyncPrototype>(globalData.heap)) JSSQLTransactionSyncPrototype(globalData, globalObject, structure);
