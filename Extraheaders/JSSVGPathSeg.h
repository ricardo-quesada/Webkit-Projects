...
public:
    ...
    {
        JSSVGPathSeg* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSeg>(globalObject->globalData().heap)) JSSVGPathSeg(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGPathSegPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegPrototype>(globalData.heap)) JSSVGPathSegPrototype(globalData, globalObject, structure);
...
public:
    ...
    static JSSVGPathSegConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGPathSegConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegConstructor>(*exec->heap())) JSSVGPathSegConstructor(structure, globalObject);
