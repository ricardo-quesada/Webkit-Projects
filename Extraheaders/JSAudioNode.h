...
public:
    ...
    {
        JSAudioNode* ptr = new (NotNull, JSC::allocateCell<JSAudioNode>(globalObject->globalData().heap)) JSAudioNode(structure, globalObject, impl);
    ...
    AudioNode* impl() const { return m_impl; }
...
public:
    ...
    static JSAudioNodePrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSAudioNodePrototype* ptr = new (NotNull, JSC::allocateCell<JSAudioNodePrototype>(globalData.heap)) JSAudioNodePrototype(globalData, globalObject, structure);
...
private:
    JSAudioNodePrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
    static const unsigned StructureFlags = JSC::OverridesGetOwnPropertySlot | Base::StructureFlags;
};
