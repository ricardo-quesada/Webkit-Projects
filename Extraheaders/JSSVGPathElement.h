...
public:
    ...
    {
        JSSVGPathElement* ptr = new (NotNull, JSC::allocateCell<JSSVGPathElement>(globalObject->globalData().heap)) JSSVGPathElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGPathElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGPathElementPrototype>(globalData.heap)) JSSVGPathElementPrototype(globalData, globalObject, structure);
...
JSC::JSValue jsSVGPathElementRequiredFeatures(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGPathElementRequiredExtensions(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGPathElementSystemLanguage(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGPathElementXmllang(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSSVGPathElementXmllang(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsSVGPathElementXmlspace(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
...
JSC::JSValue jsSVGPathElementClassName(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGPathElementStyle(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGPathElementTransform(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGPathElementNearestViewportElement(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGPathElementFarthestViewportElement(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
