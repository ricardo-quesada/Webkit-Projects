...
public:
    ...
    {
        JSSVGPathSegCurvetoCubicSmoothRel* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegCurvetoCubicSmoothRel>(globalObject->globalData().heap)) JSSVGPathSegCurvetoCubicSmoothRel(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGPathSegCurvetoCubicSmoothRelPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegCurvetoCubicSmoothRelPrototype>(globalData.heap)) JSSVGPathSegCurvetoCubicSmoothRelPrototype(globalData, globalObject, structure);
