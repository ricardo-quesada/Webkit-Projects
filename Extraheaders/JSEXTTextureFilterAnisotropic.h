...
public:
    ...
    {
        JSEXTTextureFilterAnisotropic* ptr = new (NotNull, JSC::allocateCell<JSEXTTextureFilterAnisotropic>(globalObject->globalData().heap)) JSEXTTextureFilterAnisotropic(structure, globalObject, impl);
...
public:
    ...
    static JSEXTTextureFilterAnisotropicPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSEXTTextureFilterAnisotropicPrototype* ptr = new (NotNull, JSC::allocateCell<JSEXTTextureFilterAnisotropicPrototype>(globalData.heap)) JSEXTTextureFilterAnisotropicPrototype(globalData, globalObject, structure);
...
private:
    JSEXTTextureFilterAnisotropicPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
