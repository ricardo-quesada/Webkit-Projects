...
public:
    ...
    {
        JSSVGMaskElement* ptr = new (NotNull, JSC::allocateCell<JSSVGMaskElement>(globalObject->globalData().heap)) JSSVGMaskElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGMaskElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGMaskElementPrototype>(globalData.heap)) JSSVGMaskElementPrototype(globalData, globalObject, structure);
...
JSC::JSValue jsSVGMaskElementXmllang(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSSVGMaskElementXmllang(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsSVGMaskElementXmlspace(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
...
JSC::JSValue jsSVGMaskElementClassName(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGMaskElementStyle(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
