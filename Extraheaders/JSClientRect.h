...
public:
    ...
    {
        JSClientRect* ptr = new (NotNull, JSC::allocateCell<JSClientRect>(globalObject->globalData().heap)) JSClientRect(structure, globalObject, impl);
...
public:
    ...
    {
        JSClientRectPrototype* ptr = new (NotNull, JSC::allocateCell<JSClientRectPrototype>(globalData.heap)) JSClientRectPrototype(globalData, globalObject, structure);
