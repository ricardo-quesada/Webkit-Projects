...
public:
    ...
    {
        JSTouchEvent* ptr = new (NotNull, JSC::allocateCell<JSTouchEvent>(globalObject->globalData().heap)) JSTouchEvent(structure, globalObject, impl);
...
public:
    ...
    {
        JSTouchEventPrototype* ptr = new (NotNull, JSC::allocateCell<JSTouchEventPrototype>(globalData.heap)) JSTouchEventPrototype(globalData, globalObject, structure);
