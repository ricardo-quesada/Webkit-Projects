...
public:
    ...
    {
        JSWorkerNavigator* ptr = new (NotNull, JSC::allocateCell<JSWorkerNavigator>(globalObject->globalData().heap)) JSWorkerNavigator(structure, globalObject, impl);
...
public:
    ...
    {
        JSWorkerNavigatorPrototype* ptr = new (NotNull, JSC::allocateCell<JSWorkerNavigatorPrototype>(globalData.heap)) JSWorkerNavigatorPrototype(globalData, globalObject, structure);
