...
public:
    ...
    {
        JSSVGPathSegLinetoVerticalRel* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoVerticalRel>(globalObject->globalData().heap)) JSSVGPathSegLinetoVerticalRel(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGPathSegLinetoVerticalRelPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoVerticalRelPrototype>(globalData.heap)) JSSVGPathSegLinetoVerticalRelPrototype(globalData, globalObject, structure);
...
public:
    ...
    static JSSVGPathSegLinetoVerticalRelConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGPathSegLinetoVerticalRelConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoVerticalRelConstructor>(*exec->heap())) JSSVGPathSegLinetoVerticalRelConstructor(structure, globalObject);
...
JSC::JSValue jsSVGPathSegLinetoVerticalRelY(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSSVGPathSegLinetoVerticalRelY(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsSVGPathSegLinetoVerticalRelConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
