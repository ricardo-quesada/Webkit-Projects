...
public:
    ...
    {
        JSWebKitCSSKeyframeRule* ptr = new (NotNull, JSC::allocateCell<JSWebKitCSSKeyframeRule>(globalObject->globalData().heap)) JSWebKitCSSKeyframeRule(structure, globalObject, impl);
...
public:
    ...
    static JSWebKitCSSKeyframeRulePrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSWebKitCSSKeyframeRulePrototype* ptr = new (NotNull, JSC::allocateCell<JSWebKitCSSKeyframeRulePrototype>(globalData.heap)) JSWebKitCSSKeyframeRulePrototype(globalData, globalObject, structure);
...
private:
    JSWebKitCSSKeyframeRulePrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
