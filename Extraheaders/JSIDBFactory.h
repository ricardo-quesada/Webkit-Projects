...
public:
    ...
    {
        JSIDBFactory* ptr = new (NotNull, JSC::allocateCell<JSIDBFactory>(globalObject->globalData().heap)) JSIDBFactory(structure, globalObject, impl);
...
public:
    ...
    {
        JSIDBFactoryPrototype* ptr = new (NotNull, JSC::allocateCell<JSIDBFactoryPrototype>(globalData.heap)) JSIDBFactoryPrototype(globalData, globalObject, structure);
...
public:
    ...
    static JSIDBFactoryConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSIDBFactoryConstructor* ptr = new (NotNull, JSC::allocateCell<JSIDBFactoryConstructor>(*exec->heap())) JSIDBFactoryConstructor(structure, globalObject);
...
JSC::EncodedJSValue JSC_HOST_CALL jsIDBFactoryPrototypeFunctionGetDatabaseNames(JSC::ExecState*);
