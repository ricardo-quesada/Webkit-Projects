...
public:
    ...
    {
        JSSVGTRefElement* ptr = new (NotNull, JSC::allocateCell<JSSVGTRefElement>(globalObject->globalData().heap)) JSSVGTRefElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGTRefElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGTRefElementPrototype>(globalData.heap)) JSSVGTRefElementPrototype(globalData, globalObject, structure);
...
public:
    ...
    {
        JSSVGTRefElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGTRefElementConstructor>(*exec->heap())) JSSVGTRefElementConstructor(structure, globalObject);
...
JSC::JSValue jsSVGTRefElementHref(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
JSC::JSValue jsSVGTRefElementConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
