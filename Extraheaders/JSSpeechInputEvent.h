...
public:
    ...
    {
        JSSpeechInputEvent* ptr = new (NotNull, JSC::allocateCell<JSSpeechInputEvent>(globalObject->globalData().heap)) JSSpeechInputEvent(structure, globalObject, impl);
...
public:
    ...
    {
        JSSpeechInputEventPrototype* ptr = new (NotNull, JSC::allocateCell<JSSpeechInputEventPrototype>(globalData.heap)) JSSpeechInputEventPrototype(globalData, globalObject, structure);
