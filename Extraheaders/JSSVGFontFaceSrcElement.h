...
public:
    ...
    {
        JSSVGFontFaceSrcElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFontFaceSrcElement>(globalObject->globalData().heap)) JSSVGFontFaceSrcElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSSVGFontFaceSrcElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGFontFaceSrcElementPrototype>(globalData.heap)) JSSVGFontFaceSrcElementPrototype(globalData, globalObject, structure);
...
public:
    ...
    {
        JSSVGFontFaceSrcElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGFontFaceSrcElementConstructor>(*exec->heap())) JSSVGFontFaceSrcElementConstructor(structure, globalObject);
