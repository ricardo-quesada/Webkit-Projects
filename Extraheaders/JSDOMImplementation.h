...
public:
    ...
    {
        JSDOMImplementation* ptr = new (NotNull, JSC::allocateCell<JSDOMImplementation>(globalObject->globalData().heap)) JSDOMImplementation(structure, globalObject, impl);
...
public:
    ...
    {
        JSDOMImplementationPrototype* ptr = new (NotNull, JSC::allocateCell<JSDOMImplementationPrototype>(globalData.heap)) JSDOMImplementationPrototype(globalData, globalObject, structure);
