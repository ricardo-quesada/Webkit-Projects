...
public:
    ...
    {
        JSSQLTransaction* ptr = new (NotNull, JSC::allocateCell<JSSQLTransaction>(globalObject->globalData().heap)) JSSQLTransaction(structure, globalObject, impl);
...
public:
    ...
    {
        JSSQLTransactionPrototype* ptr = new (NotNull, JSC::allocateCell<JSSQLTransactionPrototype>(globalData.heap)) JSSQLTransactionPrototype(globalData, globalObject, structure);
