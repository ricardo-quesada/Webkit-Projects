...
public:
    ...
    {
        JSDocumentType* ptr = new (NotNull, JSC::allocateCell<JSDocumentType>(globalObject->globalData().heap)) JSDocumentType(structure, globalObject, impl);
...
public:
    ...
    static JSDocumentTypePrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSDocumentTypePrototype* ptr = new (NotNull, JSC::allocateCell<JSDocumentTypePrototype>(globalData.heap)) JSDocumentTypePrototype(globalData, globalObject, structure);
...
private:
    JSDocumentTypePrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
...
public:
    ...
    static JSDocumentTypeConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSDocumentTypeConstructor* ptr = new (NotNull, JSC::allocateCell<JSDocumentTypeConstructor>(*exec->heap())) JSDocumentTypeConstructor(structure, globalObject);
