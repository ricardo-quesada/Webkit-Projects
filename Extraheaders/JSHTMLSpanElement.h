...
public:
    ...
    {
        JSHTMLSpanElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLSpanElement>(globalObject->globalData().heap)) JSHTMLSpanElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSHTMLSpanElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSHTMLSpanElementPrototype>(globalData.heap)) JSHTMLSpanElementPrototype(globalData, globalObject, structure);
