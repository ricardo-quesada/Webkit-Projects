...
public:
    ...
    {
        JSWebGLLoseContext* ptr = new (NotNull, JSC::allocateCell<JSWebGLLoseContext>(globalObject->globalData().heap)) JSWebGLLoseContext(structure, globalObject, impl);
...
public:
    ...
    static JSWebGLLoseContextPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSWebGLLoseContextPrototype* ptr = new (NotNull, JSC::allocateCell<JSWebGLLoseContextPrototype>(globalData.heap)) JSWebGLLoseContextPrototype(globalData, globalObject, structure);
...
private:
    JSWebGLLoseContextPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
