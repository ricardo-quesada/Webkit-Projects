...
public:
    ...
    {
        JSCustomEvent* ptr = new (NotNull, JSC::allocateCell<JSCustomEvent>(globalObject->globalData().heap)) JSCustomEvent(structure, globalObject, impl);
...
public:
    ...
    {
        JSCustomEventPrototype* ptr = new (NotNull, JSC::allocateCell<JSCustomEventPrototype>(globalData.heap)) JSCustomEventPrototype(globalData, globalObject, structure);
