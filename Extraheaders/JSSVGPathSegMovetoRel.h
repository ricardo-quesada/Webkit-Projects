...
public:
    ...
    {
        JSSVGPathSegMovetoRel* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegMovetoRel>(globalObject->globalData().heap)) JSSVGPathSegMovetoRel(structure, globalObject, impl);
...
public:
    ...
    static JSSVGPathSegMovetoRelPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSSVGPathSegMovetoRelPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegMovetoRelPrototype>(globalData.heap)) JSSVGPathSegMovetoRelPrototype(globalData, globalObject, structure);
...
private:
    JSSVGPathSegMovetoRelPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
...
public:
    ...
    {
        JSSVGPathSegMovetoRelConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegMovetoRelConstructor>(*exec->heap())) JSSVGPathSegMovetoRelConstructor(structure, globalObject);
