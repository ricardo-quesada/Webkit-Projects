...
public:
    ...
    {
        JSConsole* ptr = new (NotNull, JSC::allocateCell<JSConsole>(globalObject->globalData().heap)) JSConsole(structure, globalObject, impl);
...
public:
    ...
    {
        JSConsolePrototype* ptr = new (NotNull, JSC::allocateCell<JSConsolePrototype>(globalData.heap)) JSConsolePrototype(globalData, globalObject, structure);
...
JSC::JSValue jsConsoleMemory(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
