...
public:
    ...
    {
        JSOESVertexArrayObject* ptr = new (NotNull, JSC::allocateCell<JSOESVertexArrayObject>(globalObject->globalData().heap)) JSOESVertexArrayObject(structure, globalObject, impl);
...
public:
    ...
    {
        JSOESVertexArrayObjectPrototype* ptr = new (NotNull, JSC::allocateCell<JSOESVertexArrayObjectPrototype>(globalData.heap)) JSOESVertexArrayObjectPrototype(globalData, globalObject, structure);
