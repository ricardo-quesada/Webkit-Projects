...
public:
    ...
    {
        JSHTMLTableCellElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLTableCellElement>(globalObject->globalData().heap)) JSHTMLTableCellElement(structure, globalObject, impl);
...
public:
    ...
    {
        JSHTMLTableCellElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSHTMLTableCellElementPrototype>(globalData.heap)) JSHTMLTableCellElementPrototype(globalData, globalObject, structure);
...
public:
    ...
    static JSHTMLTableCellElementConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSHTMLTableCellElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSHTMLTableCellElementConstructor>(*exec->heap())) JSHTMLTableCellElementConstructor(structure, globalObject);
