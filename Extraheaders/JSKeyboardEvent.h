...
public:
    ...
    {
        JSKeyboardEvent* ptr = new (NotNull, JSC::allocateCell<JSKeyboardEvent>(globalObject->globalData().heap)) JSKeyboardEvent(structure, globalObject, impl);
...
public:
    ...
    {
        JSKeyboardEventPrototype* ptr = new (NotNull, JSC::allocateCell<JSKeyboardEventPrototype>(globalData.heap)) JSKeyboardEventPrototype(globalData, globalObject, structure);
