...
public:
    ...
    {
        JSSVGFEFuncAElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEFuncAElement>(globalObject->globalData().heap)) JSSVGFEFuncAElement(structure, globalObject, impl);
...
public:
    ...
    static JSSVGFEFuncAElementPrototype* create(JSC::JSGlobalData& globalData, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSSVGFEFuncAElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSSVGFEFuncAElementPrototype>(globalData.heap)) JSSVGFEFuncAElementPrototype(globalData, globalObject, structure);
...
private:
    JSSVGFEFuncAElementPrototype(JSC::JSGlobalData& globalData, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(globalData, structure) { }
protected:
