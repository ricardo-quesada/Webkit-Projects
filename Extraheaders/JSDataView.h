...
public:
    ...
    {
        JSDataView* ptr = new (NotNull, JSC::allocateCell<JSDataView>(globalObject->globalData().heap)) JSDataView(structure, globalObject, impl);
...
public:
    ...
    {
        JSDataViewPrototype* ptr = new (NotNull, JSC::allocateCell<JSDataViewPrototype>(globalData.heap)) JSDataViewPrototype(globalData, globalObject, structure);
