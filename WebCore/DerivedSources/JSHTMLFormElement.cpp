...
static const HashTableValue JSHTMLFormElementTableValues[14] =
{
    ...
    { "autocorrect", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsHTMLFormElementAutocorrect), (intptr_t)setJSHTMLFormElementAutocorrect THUNK_GENERATOR(0) },
    { "autocapitalize", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsHTMLFormElementAutocapitalize), (intptr_t)setJSHTMLFormElementAutocapitalize THUNK_GENERATOR(0) },
...
static JSC_CONST_HASHTABLE HashTable JSHTMLFormElementTable = { 36, 31, JSHTMLFormElementTableValues, 0 };
...
JSValue jsHTMLFormElementAutocorrect(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSHTMLFormElement* castedThis = static_cast<JSHTMLFormElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    HTMLFormElement* imp = static_cast<HTMLFormElement*>(castedThis->impl());
...
JSValue jsHTMLFormElementAutocapitalize(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSHTMLFormElement* castedThis = static_cast<JSHTMLFormElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    HTMLFormElement* imp = static_cast<HTMLFormElement*>(castedThis->impl());
...
void setJSHTMLFormElementAutocorrect(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLFormElement* castedThis = static_cast<JSHTMLFormElement*>(thisObject);
    HTMLFormElement* imp = static_cast<HTMLFormElement*>(castedThis->impl());
...
void setJSHTMLFormElementAutocapitalize(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLFormElement* castedThis = static_cast<JSHTMLFormElement*>(thisObject);
    HTMLFormElement* imp = static_cast<HTMLFormElement*>(castedThis->impl());
