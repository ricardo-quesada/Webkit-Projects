...
JSHTMLStyleElementConstructor::JSHTMLStyleElementConstructor(ExecState* exec, Structure* structure, JSDOMGlobalObject* globalObject)
...
{
    return getStaticValueSlot<JSHTMLStyleElementConstructor, JSDOMWrapper>(exec, &JSHTMLStyleElementConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSHTMLStyleElementConstructor, JSDOMWrapper>(exec, &JSHTMLStyleElementConstructorTable, this, propertyName, descriptor);
}
...
{
    return new (exec) JSHTMLStyleElementPrototype(exec->globalData(), globalObject, JSHTMLStyleElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
