...
static const HashTableValue JSHTMLObjectElementPrototypeTableValues[3] =
{
...
#undef THUNK_GENERATOR
static JSC_CONST_HASHTABLE HashTable JSHTMLObjectElementPrototypeTable = { 4, 3, JSHTMLObjectElementPrototypeTableValues, 0 };
