...
JSHTMLFrameElementConstructor::JSHTMLFrameElementConstructor(ExecState* exec, Structure* structure, JSDOMGlobalObject* globalObject)
...
{
    return new (exec) JSHTMLFrameElementPrototype(exec->globalData(), globalObject, JSHTMLFrameElementPrototype::createStructure(exec->globalData(), JSHTMLElementPrototype::self(exec, globalObject)));
}
