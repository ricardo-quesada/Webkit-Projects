...
static const HashTableValue JSDocumentTableValues[84] =
{
    ...
    { "ongesturestart", DontDelete | DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDocumentOngesturestart), (intptr_t)setJSDocumentOngesturestart THUNK_GENERATOR(0) },
    { "ongesturechange", DontDelete | DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDocumentOngesturechange), (intptr_t)setJSDocumentOngesturechange THUNK_GENERATOR(0) },
    { "ongestureend", DontDelete | DontEnum, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDocumentOngestureend), (intptr_t)setJSDocumentOngestureend THUNK_GENERATOR(0) },
    ...
    { "webkitVisibilityState", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDocumentWebkitVisibilityState), (intptr_t)0 THUNK_GENERATOR(0) },
#endif
#if ENABLE(PAGE_VISIBILITY_API)
    { "webkitIsVisible", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDocumentWebkitIsVisible), (intptr_t)0 THUNK_GENERATOR(0) },
#endif
...
static JSC_CONST_HASHTABLE HashTable JSDocumentTable = { 265, 255, JSDocumentTableValues, 0 };
...
JSValue jsDocumentOngesturestart(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* imp = static_cast<Document*>(castedThis->impl());
...
JSValue jsDocumentOngesturechange(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* imp = static_cast<Document*>(castedThis->impl());
...
JSValue jsDocumentOngestureend(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* imp = static_cast<Document*>(castedThis->impl());
...
#if ENABLE(PAGE_VISIBILITY_API)
JSValue jsDocumentWebkitVisibilityState(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* imp = static_cast<Document*>(castedThis->impl());
    JSValue result = jsString(exec, imp->webkitVisibilityState());
    return result;
}
...
#if ENABLE(PAGE_VISIBILITY_API)
JSValue jsDocumentWebkitIsVisible(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDocument* castedThis = static_cast<JSDocument*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    Document* imp = static_cast<Document*>(castedThis->impl());
    JSValue result = jsBoolean(imp->webkitIsVisible());
    return result;
}
...
void setJSDocumentOngesturestart(ExecState* exec, JSObject* thisObject, JSValue value)
{
    UNUSED_PARAM(exec);
    JSDocument* castedThis = static_cast<JSDocument*>(thisObject);
    Document* imp = static_cast<Document*>(castedThis->impl());
...
void setJSDocumentOngesturechange(ExecState* exec, JSObject* thisObject, JSValue value)
{
    UNUSED_PARAM(exec);
    JSDocument* castedThis = static_cast<JSDocument*>(thisObject);
    Document* imp = static_cast<Document*>(castedThis->impl());
...
void setJSDocumentOngestureend(ExecState* exec, JSObject* thisObject, JSValue value)
{
    UNUSED_PARAM(exec);
    JSDocument* castedThis = static_cast<JSDocument*>(thisObject);
    Document* imp = static_cast<Document*>(castedThis->impl());
...
EncodedJSValue JSC_HOST_CALL jsDocumentPrototypeFunctionCreateTouch(ExecState* exec)
{
    ...
    JSC::JSValue result = toJS(exec, castedThis->globalObject(), WTF::getPtr(imp->createTouch(view, target, identifier, pageX, pageY, screenX, screenY, ec)));
    setDOMException(exec, ec);
    return JSValue::encode(result);
}
