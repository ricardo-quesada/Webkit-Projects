...
JSC::JSValue jsHTMLTextAreaElementAutocorrect(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSHTMLTextAreaElementAutocorrect(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsHTMLTextAreaElementAutocapitalize(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSHTMLTextAreaElementAutocapitalize(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
