...
public:
    ...
    JSC::JSValue webkitCompassHeading(JSC::ExecState*) const;
    JSC::JSValue webkitCompassAccuracy(JSC::ExecState*) const;
...
JSC::JSValue jsDeviceOrientationEventWebkitCompassHeading(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
JSC::JSValue jsDeviceOrientationEventWebkitCompassAccuracy(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
