...
JSC::JSValue jsHTMLInputElementAutocorrect(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSHTMLInputElementAutocorrect(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsHTMLInputElementAutocapitalize(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSHTMLInputElementAutocapitalize(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
