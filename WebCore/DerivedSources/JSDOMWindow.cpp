...
static const HashTableValue JSDOMWindowTableValues[309] =
{
    ...
    { "ongesturestart", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowOngesturestart), (intptr_t)setJSDOMWindowOngesturestart THUNK_GENERATOR(0) },
    { "ongesturechange", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowOngesturechange), (intptr_t)setJSDOMWindowOngesturechange THUNK_GENERATOR(0) },
    { "ongestureend", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowOngestureend), (intptr_t)setJSDOMWindowOngestureend THUNK_GENERATOR(0) },
...
#endif
    { "Touch", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowTouchConstructor), (intptr_t)setJSDOMWindowTouchConstructor THUNK_GENERATOR(0) },
    { "TouchList", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDOMWindowTouchListConstructor), (intptr_t)setJSDOMWindowTouchListConstructor THUNK_GENERATOR(0) },
...
static JSC_CONST_HASHTABLE HashTable JSDOMWindowTable = { 1067, 1023, JSDOMWindowTableValues, 0 };
...
JSValue jsDOMWindowOngesturestart(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDOMWindow* castedThis = static_cast<JSDOMWindow*>(asObject(slotBase));
    if (!castedThis->allowsAccessFrom(exec))
        return jsUndefined();
    UNUSED_PARAM(exec);
    DOMWindow* imp = static_cast<DOMWindow*>(castedThis->impl());
    if (EventListener* listener = imp->ongesturestart()) {
        if (const JSEventListener* jsListener = JSEventListener::cast(listener)) {
            if (JSObject* jsFunction = jsListener->jsFunction(imp->scriptExecutionContext()))
                return jsFunction;
        }
...
JSValue jsDOMWindowOngesturechange(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDOMWindow* castedThis = static_cast<JSDOMWindow*>(asObject(slotBase));
    if (!castedThis->allowsAccessFrom(exec))
        return jsUndefined();
    UNUSED_PARAM(exec);
    DOMWindow* imp = static_cast<DOMWindow*>(castedThis->impl());
    if (EventListener* listener = imp->ongesturechange()) {
        if (const JSEventListener* jsListener = JSEventListener::cast(listener)) {
            if (JSObject* jsFunction = jsListener->jsFunction(imp->scriptExecutionContext()))
                return jsFunction;
        }
...
JSValue jsDOMWindowOngestureend(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDOMWindow* castedThis = static_cast<JSDOMWindow*>(asObject(slotBase));
    if (!castedThis->allowsAccessFrom(exec))
        return jsUndefined();
    UNUSED_PARAM(exec);
    DOMWindow* imp = static_cast<DOMWindow*>(castedThis->impl());
    if (EventListener* listener = imp->ongestureend()) {
        if (const JSEventListener* jsListener = JSEventListener::cast(listener)) {
            if (JSObject* jsFunction = jsListener->jsFunction(imp->scriptExecutionContext()))
                return jsFunction;
        }
...
JSValue jsDOMWindowTouchConstructor(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDOMWindow* castedThis = static_cast<JSDOMWindow*>(asObject(slotBase));
    if (!castedThis->allowsAccessFrom(exec))
        return jsUndefined();
    return castedThis->touch(exec);
}


JSValue jsDOMWindowTouchListConstructor(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDOMWindow* castedThis = static_cast<JSDOMWindow*>(asObject(slotBase));
    if (!castedThis->allowsAccessFrom(exec))
        return jsUndefined();
    return castedThis->touchList(exec);
}
...
void setJSDOMWindowOngesturestart(ExecState* exec, JSObject* thisObject, JSValue value)
{
    if (!static_cast<JSDOMWindow*>(thisObject)->allowsAccessFrom(exec))
        return;
    UNUSED_PARAM(exec);
    JSDOMWindow* castedThis = static_cast<JSDOMWindow*>(thisObject);
    DOMWindow* imp = static_cast<DOMWindow*>(castedThis->impl());
    imp->setOngesturestart(createJSAttributeEventListener(exec, value, thisObject));
}


void setJSDOMWindowOngesturechange(ExecState* exec, JSObject* thisObject, JSValue value)
{
    if (!static_cast<JSDOMWindow*>(thisObject)->allowsAccessFrom(exec))
        return;
    UNUSED_PARAM(exec);
    JSDOMWindow* castedThis = static_cast<JSDOMWindow*>(thisObject);
    DOMWindow* imp = static_cast<DOMWindow*>(castedThis->impl());
    imp->setOngesturechange(createJSAttributeEventListener(exec, value, thisObject));
}


void setJSDOMWindowOngestureend(ExecState* exec, JSObject* thisObject, JSValue value)
{
    if (!static_cast<JSDOMWindow*>(thisObject)->allowsAccessFrom(exec))
        return;
    UNUSED_PARAM(exec);
    JSDOMWindow* castedThis = static_cast<JSDOMWindow*>(thisObject);
    DOMWindow* imp = static_cast<DOMWindow*>(castedThis->impl());
    imp->setOngestureend(createJSAttributeEventListener(exec, value, thisObject));
}
...
void setJSDOMWindowTouchConstructor(ExecState* exec, JSObject* thisObject, JSValue value)
{
    if (!static_cast<JSDOMWindow*>(thisObject)->allowsAccessFrom(exec))
        return;
    // Shadowing a built-in constructor
    static_cast<JSDOMWindow*>(thisObject)->putDirect(exec->globalData(), Identifier(exec, "Touch"), value);
}
...
void setJSDOMWindowTouchListConstructor(ExecState* exec, JSObject* thisObject, JSValue value)
{
    if (!static_cast<JSDOMWindow*>(thisObject)->allowsAccessFrom(exec))
        return;
    // Shadowing a built-in constructor
    static_cast<JSDOMWindow*>(thisObject)->putDirect(exec->globalData(), Identifier(exec, "TouchList"), value);
}
