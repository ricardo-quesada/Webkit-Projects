...
JSC::JSValue jsElementOngesturestart(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSElementOngesturestart(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsElementOngesturechange(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSElementOngesturechange(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsElementOngestureend(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSElementOngestureend(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
