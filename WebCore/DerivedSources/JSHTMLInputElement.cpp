...
static const HashTableValue JSHTMLInputElementTableValues[45] =
{
    ...
    { "autocorrect", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsHTMLInputElementAutocorrect), (intptr_t)setJSHTMLInputElementAutocorrect THUNK_GENERATOR(0) },
    { "autocapitalize", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsHTMLInputElementAutocapitalize), (intptr_t)setJSHTMLInputElementAutocapitalize THUNK_GENERATOR(0) },
...
JSValue jsHTMLInputElementAutocorrect(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSHTMLInputElement* castedThis = static_cast<JSHTMLInputElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    HTMLInputElement* imp = static_cast<HTMLInputElement*>(castedThis->impl());
...
JSValue jsHTMLInputElementAutocapitalize(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSHTMLInputElement* castedThis = static_cast<JSHTMLInputElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    HTMLInputElement* imp = static_cast<HTMLInputElement*>(castedThis->impl());
...
void setJSHTMLInputElementAutocorrect(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLInputElement* castedThis = static_cast<JSHTMLInputElement*>(thisObject);
    HTMLInputElement* imp = static_cast<HTMLInputElement*>(castedThis->impl());
...
void setJSHTMLInputElementAutocapitalize(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLInputElement* castedThis = static_cast<JSHTMLInputElement*>(thisObject);
    HTMLInputElement* imp = static_cast<HTMLInputElement*>(castedThis->impl());
