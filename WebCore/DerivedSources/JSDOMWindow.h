...
JSC::JSValue jsDOMWindowOngesturestart(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDOMWindowOngesturestart(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsDOMWindowOngesturechange(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDOMWindowOngesturechange(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsDOMWindowOngestureend(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDOMWindowOngestureend(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
...
JSC::JSValue jsDOMWindowTouchConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDOMWindowTouchConstructor(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsDOMWindowTouchListConstructor(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
