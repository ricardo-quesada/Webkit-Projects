...
public:
    JSSVGFEComponentTransferElementConstructor(JSC::ExecState*, JSC::Structure*, JSDOMGlobalObject*);
...
JSSVGFEComponentTransferElementConstructor::JSSVGFEComponentTransferElementConstructor(ExecState* exec, Structure* structure, JSDOMGlobalObject* globalObject)
...
{
    return getStaticValueSlot<JSSVGFEComponentTransferElementConstructor, JSDOMWrapper>(exec, &JSSVGFEComponentTransferElementConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSSVGFEComponentTransferElementConstructor, JSDOMWrapper>(exec, &JSSVGFEComponentTransferElementConstructorTable, this, propertyName, descriptor);
}
...
{
    return new (exec) JSSVGFEComponentTransferElementPrototype(exec->globalData(), globalObject, JSSVGFEComponentTransferElementPrototype::createStructure(exec->globalData(), JSSVGElementPrototype::self(exec, globalObject)));
}
