...
JSC::JSValue jsHTMLFormElementAutocorrect(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSHTMLFormElementAutocorrect(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsHTMLFormElementAutocapitalize(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSHTMLFormElementAutocapitalize(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
