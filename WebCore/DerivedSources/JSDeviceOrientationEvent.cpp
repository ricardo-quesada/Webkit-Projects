...
static const HashTableValue JSDeviceOrientationEventTableValues[7] =
{
    ...
    { "webkitCompassHeading", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDeviceOrientationEventWebkitCompassHeading), (intptr_t)0 THUNK_GENERATOR(0) },
    { "webkitCompassAccuracy", DontDelete | ReadOnly, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsDeviceOrientationEventWebkitCompassAccuracy), (intptr_t)0 THUNK_GENERATOR(0) },
...
static JSC_CONST_HASHTABLE HashTable JSDeviceOrientationEventTable = { 16, 15, JSDeviceOrientationEventTableValues, 0 };
...
{
    { "initDeviceOrientationEvent", DontDelete | Function, (intptr_t)static_cast<NativeFunction>(jsDeviceOrientationEventPrototypeFunctionInitDeviceOrientationEvent), (intptr_t)8 THUNK_GENERATOR(0) },
    { 0, 0, 0, 0 THUNK_GENERATOR(0) }
};
...
JSValue jsDeviceOrientationEventWebkitCompassHeading(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDeviceOrientationEvent* castedThis = static_cast<JSDeviceOrientationEvent*>(asObject(slotBase));
    return castedThis->webkitCompassHeading(exec);
}


JSValue jsDeviceOrientationEventWebkitCompassAccuracy(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSDeviceOrientationEvent* castedThis = static_cast<JSDeviceOrientationEvent*>(asObject(slotBase));
    return castedThis->webkitCompassAccuracy(exec);
}
