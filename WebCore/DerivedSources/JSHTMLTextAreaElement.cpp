...
static const HashTableValue JSHTMLTextAreaElementTableValues[25] =
{
    ...
    { "autocorrect", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsHTMLTextAreaElementAutocorrect), (intptr_t)setJSHTMLTextAreaElementAutocorrect THUNK_GENERATOR(0) },
    { "autocapitalize", DontDelete, (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsHTMLTextAreaElementAutocapitalize), (intptr_t)setJSHTMLTextAreaElementAutocapitalize THUNK_GENERATOR(0) },
...
static JSC_CONST_HASHTABLE HashTable JSHTMLTextAreaElementTable = { 69, 63, JSHTMLTextAreaElementTableValues, 0 };
...
JSValue jsHTMLTextAreaElementAutocorrect(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSHTMLTextAreaElement* castedThis = static_cast<JSHTMLTextAreaElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    HTMLTextAreaElement* imp = static_cast<HTMLTextAreaElement*>(castedThis->impl());
    JSValue result = jsBoolean(imp->autocorrect());
    return result;
}


JSValue jsHTMLTextAreaElementAutocapitalize(ExecState* exec, JSValue slotBase, const Identifier&)
{
    JSHTMLTextAreaElement* castedThis = static_cast<JSHTMLTextAreaElement*>(asObject(slotBase));
    UNUSED_PARAM(exec);
    HTMLTextAreaElement* imp = static_cast<HTMLTextAreaElement*>(castedThis->impl());
    JSValue result = jsString(exec, imp->autocapitalize());
    return result;
}
...
void setJSHTMLTextAreaElementAutocorrect(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLTextAreaElement* castedThis = static_cast<JSHTMLTextAreaElement*>(thisObject);
    HTMLTextAreaElement* imp = static_cast<HTMLTextAreaElement*>(castedThis->impl());
    imp->setAutocorrect(value.toBoolean(exec));
}


void setJSHTMLTextAreaElementAutocapitalize(ExecState* exec, JSObject* thisObject, JSValue value)
{
    JSHTMLTextAreaElement* castedThis = static_cast<JSHTMLTextAreaElement*>(thisObject);
    HTMLTextAreaElement* imp = static_cast<HTMLTextAreaElement*>(castedThis->impl());
    imp->setAutocapitalize(valueToStringWithNullCheck(exec, value));
}
