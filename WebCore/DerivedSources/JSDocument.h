...
JSC::JSValue jsDocumentOngesturestart(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDocumentOngesturestart(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsDocumentOngesturechange(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDocumentOngesturechange(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsDocumentOngestureend(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
void setJSDocumentOngestureend(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
...
JSC::JSValue jsDocumentWebkitIsVisible(JSC::ExecState*, JSC::JSValue, const JSC::Identifier&);
