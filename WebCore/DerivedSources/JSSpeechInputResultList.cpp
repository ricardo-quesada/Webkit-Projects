...
public:
    JSSpeechInputResultListConstructor(JSC::ExecState*, JSC::Structure*, JSDOMGlobalObject*);
...
JSSpeechInputResultListConstructor::JSSpeechInputResultListConstructor(ExecState* exec, Structure* structure, JSDOMGlobalObject* globalObject)
...
{
    return getStaticValueSlot<JSSpeechInputResultListConstructor, JSDOMWrapper>(exec, &JSSpeechInputResultListConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSSpeechInputResultListConstructor, JSDOMWrapper>(exec, &JSSpeechInputResultListConstructorTable, this, propertyName, descriptor);
}
...
const ClassInfo JSSpeechInputResultList::s_info = { "SpeechInputResultList", &JSDOMWrapper::s_info, &JSSpeechInputResultListTable, 0 };
...
{
    return new (exec) JSSpeechInputResultListPrototype(exec->globalData(), globalObject, JSSpeechInputResultListPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
