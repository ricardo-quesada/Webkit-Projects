    ...
    : DOMConstructorObject(structure, globalObject)
{
    ...
    putDirect(exec->globalData(), exec->propertyNames().prototype, JSXPathResultPrototype::self(exec, globalObject), DontDelete | ReadOnly);
}

bool JSXPathResultConstructor::getOwnPropertySlot(ExecState* exec, const Identifier& propertyName, PropertySlot& slot)
{
    return getStaticValueSlot<JSXPathResultConstructor, JSDOMWrapper>(exec, &JSXPathResultConstructorTable, this, propertyName, slot);
}
...
{
    return getStaticValueDescriptor<JSXPathResultConstructor, JSDOMWrapper>(exec, &JSXPathResultConstructorTable, this, propertyName, descriptor);
}
...
{
    return new (exec) JSXPathResultPrototype(exec->globalData(), globalObject, JSXPathResultPrototype::createStructure(globalObject->globalData(), globalObject->objectPrototype()));
}
